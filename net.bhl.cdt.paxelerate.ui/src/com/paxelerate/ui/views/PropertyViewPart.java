...
import com.paxelerate.model.storage.AgeStorage;
import com.paxelerate.model.storage.GaussianStorage;
import com.paxelerate.model.storage.StorageHandler;
import com.paxelerate.model.storage.StorageHandler.StoreType;
import com.paxelerate.ui.color.ColorHelper;
import com.paxelerate.ui.font.FontHelper;
...
public class PropertyViewPart extends ViewPart {
		...
		try {
			...
			canvas.addPaintListener(new PaintListener() {
				public void paintControl(final PaintEvent e) {
					...
					e.gc.setBackground(ColorHelper.PASSENGER_FEMALE);
	...
	private void drawFunction(PaintEvent e, AgeStorage store, Sex sex,
		...
		if (sex == Sex.MALE) {
			...
			e.gc.setForeground(ColorHelper.PASSENGER_FEMALE);
		} else {
