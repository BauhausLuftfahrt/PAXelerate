 ...
 * </p>
 * <ul>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getId <em>Id</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getSex <em>Sex</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getHeight <em>Height</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getAge <em>Age</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getWeight <em>Weight</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getDoor <em>Door</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getSeat <em>Seat</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getName <em>Name</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getBoardingTime <em>Boarding Time</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getSeatRef <em>Seat Ref</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getWidth <em>Width</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getDepth <em>Depth</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getOrientationInDegree <em>Orientation In Degree</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getPositionX <em>Position X</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getPositionY <em>Position Y</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#isIsSeated <em>Is Seated</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getWalkingSpeed <em>Walking Speed</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getStartBoardingAfterDelay <em>Start Boarding After Delay</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getNumberOfWaits <em>Number Of Waits</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getLuggageStowTime <em>Luggage Stow Time</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getTravelClass <em>Travel Class</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getPassengerMood <em>Passenger Mood</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getNumberOfMakeWayOperations <em>Number Of Make Way Operations</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.PassengerImpl#getLuggage <em>Luggage</em>}</li>
 * </ul>
 *
 * @generated
 */
