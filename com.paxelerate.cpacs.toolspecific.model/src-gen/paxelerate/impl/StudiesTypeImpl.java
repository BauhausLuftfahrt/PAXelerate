 ...
 * </p>
 * <ul>
 *   <li>{@link paxelerate.impl.StudiesTypeImpl#getStudy <em>Study</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StudiesTypeImpl extends MinimalEObjectImpl.Container implements StudiesType {
	/**
	...
	protected EClass eStaticClass() {
		return PaxeleratePackage.Literals.STUDIES_TYPE;
	}
	...
	public EList<StudyType> getStudy() {
		if (study == null) {
			study = new EObjectContainmentEList<StudyType>(StudyType.class, this,
					PaxeleratePackage.STUDIES_TYPE__STUDY);
		}
		return study;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PaxeleratePackage.STUDIES_TYPE__STUDY:
