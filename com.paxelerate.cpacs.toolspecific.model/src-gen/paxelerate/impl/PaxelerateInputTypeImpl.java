 ...
 * </p>
 * <ul>
 *   <li>{@link paxelerate.impl.PaxelerateInputTypeImpl#getStudies <em>Studies</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PaxelerateInputTypeImpl extends ComplexBaseTypeImpl implements PaxelerateInputType {
	...
	protected EClass eStaticClass() {
		return PaxeleratePackage.Literals.PAXELERATE_INPUT_TYPE;
	}
	...
	public NotificationChain basicSetStudies(StudiesType newStudies, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					PaxeleratePackage.PAXELERATE_INPUT_TYPE__STUDIES, oldStudies, newStudies);
			if (msgs == null)
				msgs = notification;
			else
		...
		if (newStudies != studies) {
			...
			if (studies != null)
				msgs = ((InternalEObject) studies).eInverseRemove(this,
						EOPPOSITE_FEATURE_BASE - PaxeleratePackage.PAXELERATE_INPUT_TYPE__STUDIES, null, msgs);
			if (newStudies != null)
			...
			eNotify(new ENotificationImpl(this, Notification.SET, PaxeleratePackage.PAXELERATE_INPUT_TYPE__STUDIES,
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
		case PaxeleratePackage.PAXELERATE_INPUT_TYPE__STUDIES:
