 ...
 * </p>
 * <ul>
 *   <li>{@link toolspecific.impl.DateTimeBaseTypeImpl#getValue <em>Value</em>}</li>
 *   <li>{@link toolspecific.impl.DateTimeBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link toolspecific.impl.DateTimeBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link toolspecific.impl.DateTimeBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DateTimeBaseTypeImpl extends MinimalEObjectImpl.Container implements DateTimeBaseType {
	...
	protected EClass eStaticClass() {
		return ToolspecificPackage.Literals.DATE_TIME_BASE_TYPE;
	}
	...
	public void setValue(XMLGregorianCalendar newValue) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, ToolspecificPackage.DATE_TIME_BASE_TYPE__VALUE,
					oldValue, value));
	}
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ToolspecificPackage.DATE_TIME_BASE_TYPE__EXTERNAL_DATA_DIRECTORY, oldExternalDataDirectory,
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ToolspecificPackage.DATE_TIME_BASE_TYPE__EXTERNAL_DATA_NODE_PATH, oldExternalDataNodePath,
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ToolspecificPackage.DATE_TIME_BASE_TYPE__EXTERNAL_FILE_NAME, oldExternalFileName,
					externalFileName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ToolspecificPackage.DATE_TIME_BASE_TYPE__VALUE:
			return getValue();
		case ToolspecificPackage.DATE_TIME_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case ToolspecificPackage.DATE_TIME_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case ToolspecificPackage.DATE_TIME_BASE_TYPE__EXTERNAL_FILE_NAME:
