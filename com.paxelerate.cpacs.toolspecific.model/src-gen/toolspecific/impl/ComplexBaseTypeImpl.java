 ...
 * </p>
 * <ul>
 *   <li>{@link toolspecific.impl.ComplexBaseTypeImpl#getExternalDataDirectory <em>External Data Directory</em>}</li>
 *   <li>{@link toolspecific.impl.ComplexBaseTypeImpl#getExternalDataNodePath <em>External Data Node Path</em>}</li>
 *   <li>{@link toolspecific.impl.ComplexBaseTypeImpl#getExternalFileName <em>External File Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ComplexBaseTypeImpl extends MinimalEObjectImpl.Container implements ComplexBaseType {
	...
	protected EClass eStaticClass() {
		return ToolspecificPackage.Literals.COMPLEX_BASE_TYPE;
	}
	...
	public void setExternalDataDirectory(String newExternalDataDirectory) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ToolspecificPackage.COMPLEX_BASE_TYPE__EXTERNAL_DATA_DIRECTORY, oldExternalDataDirectory,
	...
	public void setExternalDataNodePath(String newExternalDataNodePath) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ToolspecificPackage.COMPLEX_BASE_TYPE__EXTERNAL_DATA_NODE_PATH, oldExternalDataNodePath,
	...
	public void setExternalFileName(String newExternalFileName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					ToolspecificPackage.COMPLEX_BASE_TYPE__EXTERNAL_FILE_NAME, oldExternalFileName, externalFileName));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case ToolspecificPackage.COMPLEX_BASE_TYPE__EXTERNAL_DATA_DIRECTORY:
			return getExternalDataDirectory();
		case ToolspecificPackage.COMPLEX_BASE_TYPE__EXTERNAL_DATA_NODE_PATH:
			return getExternalDataNodePath();
		case ToolspecificPackage.COMPLEX_BASE_TYPE__EXTERNAL_FILE_NAME:
