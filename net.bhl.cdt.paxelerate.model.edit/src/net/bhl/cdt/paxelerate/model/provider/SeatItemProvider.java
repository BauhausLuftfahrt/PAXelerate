 ...
 * {@link net.bhl.cdt.paxelerate.model.Seat} object. <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class SeatItemProvider extends PhysicalObjectItemProvider {
	/**
	...
	protected void addSeatBlockedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_seatBlocked_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_seatBlocked_feature",
								"_UI_Seat_type"),
						CabinPackage.Literals.SEAT__SEAT_BLOCKED, true, false, false,
	...
	protected void addCrewSeatPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_crewSeat_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_crewSeat_feature", "_UI_Seat_type"),
						CabinPackage.Literals.SEAT__CREW_SEAT, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addLetterPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_letter_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_letter_feature", "_UI_Seat_type"),
						CabinPackage.Literals.SEAT__LETTER, true, false, false,
	...
	protected void addTravelClassPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_travelClass_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_travelClass_feature",
								"_UI_Seat_type"),
						CabinPackage.Literals.SEAT__TRAVEL_CLASS, true, false, true, null, null, null));
	}
	...
	protected void addRowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_row_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_row_feature", "_UI_Seat_type"),
						CabinPackage.Literals.SEAT__ROW, true, false, true, null, null, null));
	}
	...
	protected void addOccupiedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_occupied_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_occupied_feature", "_UI_Seat_type"),
						CabinPackage.Literals.SEAT__OCCUPIED, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}
	...
	protected void addPassengerPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_passenger_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_passenger_feature", "_UI_Seat_type"),
						CabinPackage.Literals.SEAT__PASSENGER, true, false, true, null, null, null));
	}
	...
	protected void addCurrentlyFoldedPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Seat_currentlyFolded_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Seat_currentlyFolded_feature",
								"_UI_Seat_type"),
						CabinPackage.Literals.SEAT__CURRENTLY_FOLDED, true, false, false,
						ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE, null, null));
	}

	/**
	 * This returns Seat.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_Seat_type")
