 ...
 * {@link net.bhl.cdt.paxelerate.model.Row} object. <!-- begin-user-doc --> <!--
 * end-user-doc -->
 * 
 * @generated
 */
public class RowItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addRowNumberPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Row_rowNumber_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Row_rowNumber_feature", "_UI_Row_type"),
						CabinPackage.Literals.ROW__ROW_NUMBER, true, false, false,
	...
	protected void addOffsetInRowPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_Row_offsetInRow_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_Row_offsetInRow_feature", "_UI_Row_type"),
						CabinPackage.Literals.ROW__OFFSET_IN_ROW, true, false, false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(CabinPackage.Literals.ROW__SEATS);
		}
	...
	/**
	 * This returns Row.gif. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	@Override
	...
	public String getText(Object object) {
		Row row = (Row) object;
		return getString("_UI_Row_type") + " " + row.getRowNumber();
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors
				.add(createChildParameter(CabinPackage.Literals.ROW__SEATS, CabinFactory.eINSTANCE.createSeat()));
	}
