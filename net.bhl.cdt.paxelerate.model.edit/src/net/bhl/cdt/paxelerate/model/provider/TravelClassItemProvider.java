...
public class TravelClassItemProvider extends ItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addSeatLengthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TravelClass_seatLength_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TravelClass_seatLength_feature",
								"_UI_TravelClass_type"),
						CabinPackage.Literals.TRAVEL_CLASS__SEAT_LENGTH, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	protected void addSeatWidthPropertyDescriptor(Object object) {
		itemPropertyDescriptors
				.add(createItemPropertyDescriptor(((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(),
						getResourceLocator(), getString("_UI_TravelClass_seatWidth_feature"),
						getString("_UI_PropertyDescriptor_description", "_UI_TravelClass_seatWidth_feature",
								"_UI_TravelClass_type"),
						CabinPackage.Literals.TRAVEL_CLASS__SEAT_WIDTH, true, false, false,
						ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE, null, null));
	}
	...
	public String getText(Object object) {
		...
		return label == null || label.length() == 0 ? getString("_UI_TravelClass_type")
