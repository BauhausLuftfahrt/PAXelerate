 ...
 * </p>
 * <ul>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getCabinLength <em>Cabin Length</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getCabinWidth <em>Cabin Width</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getRowNonexistent <em>Row Nonexistent</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getAisleWidth <em>Aisle Width</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getFramesPerSecond <em>Frames Per Second</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getNumberOfDecks <em>Number Of Decks</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getSimulationSettings <em>Simulation Settings</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getClasses <em>Classes</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getDoors <em>Doors</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getLavatories <em>Lavatories</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getGalleys <em>Galleys</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getStairways <em>Stairways</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getCurtains <em>Curtains</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getStowages <em>Stowages</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getPassengers <em>Passengers</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getScale <em>Scale</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getAircraftType <em>Aircraft Type</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#isUsePresetSettings <em>Use Preset Settings</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.CabinImpl#getSpeedFactor <em>Speed Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
