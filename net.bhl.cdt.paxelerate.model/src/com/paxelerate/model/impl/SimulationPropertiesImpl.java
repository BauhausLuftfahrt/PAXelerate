 ...
 * </p>
 * <ul>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#isSimulateWithoutUI <em>Simulate Without UI</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getNumberOfSimulationLoops <em>Number Of Simulation Loops</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#isRandomSortBetweenLoops <em>Random Sort Between Loops</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#isUseFoldableSeats <em>Use Foldable Seats</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#isBringYourOwnSeat <em>Bring Your Own Seat</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengersBoardingPerMinute <em>Passengers Boarding Per Minute</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWidthMeanMale <em>Passenger Width Mean Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWidthDeviationMale <em>Passenger Width Deviation Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWeightMeanMale <em>Passenger Weight Mean Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWeightDeviationMale <em>Passenger Weight Deviation Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerHeightMeanMale <em>Passenger Height Mean Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerHeightDeviationMale <em>Passenger Height Deviation Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerDepthMeanMale <em>Passenger Depth Mean Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerDepthDeviationMale <em>Passenger Depth Deviation Male</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPercentageOfWomen <em>Percentage Of Women</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerLuggageStowTimeMean <em>Passenger Luggage Stow Time Mean</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerLuggageStowTimeDeviation <em>Passenger Luggage Stow Time Deviation</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWidthMeanFemale <em>Passenger Width Mean Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWidthDeviationFemale <em>Passenger Width Deviation Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWeightMeanFemale <em>Passenger Weight Mean Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerWeightDeviationFemale <em>Passenger Weight Deviation Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerHeightMeanFemale <em>Passenger Height Mean Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerHeightDeviationFemale <em>Passenger Height Deviation Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerDepthMeanFemale <em>Passenger Depth Mean Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPassengerDepthDeviationFemale <em>Passenger Depth Deviation Female</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getResults <em>Results</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPercentageOfPassengersWithNoLuggage <em>Percentage Of Passengers With No Luggage</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPercentageOfPassengersWithSmallLuggage <em>Percentage Of Passengers With Small Luggage</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPercentageOfPassengersWithMediumLuggage <em>Percentage Of Passengers With Medium Luggage</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getPercentageOfPassengersWithBigLuggage <em>Percentage Of Passengers With Big Luggage</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getSorting <em>Sorting</em>}</li>
 *   <li>{@link com.paxelerate.model.impl.SimulationPropertiesImpl#getSimulationSpeedFactor <em>Simulation Speed Factor</em>}</li>
 * </ul>
 *
 * @generated
 */
