 ...
 * <em><b>Simulation Result</b></em>'. <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>
 * {@link net.bhl.cdt.paxelerate.model.impl.SimulationResultImpl#getBoardingTime
 * <em>Boarding Time</em>}</li>
 * <li>
 * {@link net.bhl.cdt.paxelerate.model.impl.SimulationResultImpl#getPassengers
 * <em>Passengers</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SimulationResultImpl#getName
 * <em>Name</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SimulationResultImpl#getId
 * <em>Id</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SimulationResultImpl#getDate
 * <em>Date</em>}</li>
 * <li>
 * {@link net.bhl.cdt.paxelerate.model.impl.SimulationResultImpl#getBoardingTimeString
 * <em>Boarding Time String</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class SimulationResultImpl extends MinimalEObjectImpl.Container
	...
	/**
	 * The default value of the '{@link #getBoardingTimeString()
	 * <em>Boarding Time String</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getBoardingTimeString()
	 * <em>Boarding Time String</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getBoardingTimeString()
	...
	public void setBoardingTime(double newBoardingTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SIMULATION_RESULT__BOARDING_TIME,
	...
	public void setPassengers(int newPassengers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SIMULATION_RESULT__PASSENGERS, oldPassengers,
					passengers));
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SIMULATION_RESULT__NAME, oldName, name));
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SIMULATION_RESULT__ID, oldId, id));
	}
	...
	public void setDate(Date newDate) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SIMULATION_RESULT__DATE, oldDate, date));
	}
	...
	public void setBoardingTimeString(String newBoardingTimeString) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SIMULATION_RESULT__BOARDING_TIME_STRING,
	...
	public boolean eIsSet(int featureID) {
		...
		case CabinPackage.SIMULATION_RESULT__BOARDING_TIME_STRING:
			return BOARDING_TIME_STRING_EDEFAULT == null
					? boardingTimeString != null
