 ...
 * <ul>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.CrewMemberImpl#getId <em>Id</em>
 * }</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.CrewMemberImpl#getSeat
 * <em>Seat</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class CrewMemberImpl extends MinimalEObjectImpl.Container
		implements CrewMember {
	/**
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CREW_MEMBER__ID, oldId, id));
	}
			...
			if (seat != oldSeat) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CabinPackage.CREW_MEMBER__SEAT, oldSeat, seat));
			}
		}
		return seat;
	}
