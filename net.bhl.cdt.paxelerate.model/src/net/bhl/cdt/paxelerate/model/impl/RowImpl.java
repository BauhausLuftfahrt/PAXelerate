 ...
 * <ul>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.RowImpl#getSeats <em>Seats</em>}
 * </li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.RowImpl#getRowNumber
 * <em>Row Number</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.RowImpl#isOffsetInRow
...
public class RowImpl extends MinimalEObjectImpl.Container implements Row {
	/**
	 * The cached value of the '{@link #getSeats() <em>Seats</em>}' containment
	...
	/**
	 * The default value of the '{@link #isOffsetInRow() <em>Offset In Row</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOffsetInRow()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isOffsetInRow() <em>Offset In Row</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOffsetInRow()
	 * @generated
	...
	public EList<Seat> getSeats() {
		if (seats == null) {
			seats = new EObjectContainmentEList<Seat>(Seat.class, this,
					CabinPackage.ROW__SEATS);
		}
		return seats;
	}
	...
	public void setRowNumber(int newRowNumber) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.ROW__ROW_NUMBER, oldRowNumber, rowNumber));
	}
	...
	public void setOffsetInRow(boolean newOffsetInRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.ROW__OFFSET_IN_ROW, oldOffsetInRow,
					offsetInRow));
	}
