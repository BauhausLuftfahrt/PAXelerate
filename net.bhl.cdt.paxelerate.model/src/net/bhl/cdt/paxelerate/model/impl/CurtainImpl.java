 ...
 * <ul>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.CurtainImpl#getPostitionAfterRow
 * <em>Postition After Row</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.CurtainImpl#isCurtainOpen
...
public class CurtainImpl extends PhysicalObjectImpl implements Curtain {
	/**
	 * The default value of the '{@link #getPostitionAfterRow()
	...
	/**
	 * The cached value of the '{@link #getPostitionAfterRow()
	 * <em>Postition After Row</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getPostitionAfterRow()
	...
	/**
	 * The default value of the '{@link #isCurtainOpen() <em>Curtain Open</em>}'
	...
	/**
	 * The cached value of the '{@link #isCurtainOpen() <em>Curtain Open</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isCurtainOpen()
	 * @generated
	...
	public void setPostitionAfterRow(int newPostitionAfterRow) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CURTAIN__POSTITION_AFTER_ROW,
					oldPostitionAfterRow, postitionAfterRow));
	}
	...
	public void setCurtainOpen(boolean newCurtainOpen) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CURTAIN__CURTAIN_OPEN, oldCurtainOpen,
					curtainOpen));
	}
