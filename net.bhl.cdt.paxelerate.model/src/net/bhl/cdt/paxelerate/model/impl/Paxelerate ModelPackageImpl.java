...
import model.Curtain;
import model.Door;
import model.EconomyClass;
import model.EmergencyExit;
import model.FirstClass;
import model.Galley;
import model.Lavatory;
import model.LuggageSize;
import model.MainDoor;
import model.Passenger;
import model.PassengerMood;
import model.PaxelerateModelFactory;
import model.PaxelerateModelPackage;
import model.PhysicalObject;
import model.PremiumEconomyClass;
import model.Row;
import model.Seat;
import model.Sex;
import model.SimulationProperties;
import model.SimulationResult;
import model.SortingStyle;
import model.Stairway;
import model.StairwayDirection;
import model.StandardDoor;
import model.Stowage;
import model.TravelClass;

import model.util.PaxelerateModelValidator;
 ...
 * @generated
 */
public class Paxelerate ModelPackageImpl extends EPackageImpl implements Paxelerate ModelPackage {
	/**
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 ...
	 * @see model.Paxelerate ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	private Paxelerate ModelPackageImpl() {
		super(eNS_URI, Paxelerate ModelFactory.eINSTANCE);
	}
	 ...
	 * 
	 * <p>This method is used to initialize {@link Paxelerate ModelPackage#eINSTANCE} when that field is accessed.
	 ...
	 * @generated
	 */
	public static Paxelerate ModelPackage init() {
		if (isInited) return (Paxelerate ModelPackage)EPackage.Registry.INSTANCE.getEPackage(Paxelerate ModelPackage.eNS_URI);

		// Obtain or create and register package
		Paxelerate ModelPackageImpl thePaxelerate ModelPackage = (Paxelerate ModelPackageImpl)(EPackage.Registry.INSTANCE.get(eNS_URI) instanceof Paxelerate ModelPackageImpl ? EPackage.Registry.INSTANCE.get(eNS_URI) : new Paxelerate ModelPackageImpl());
		...
		thePaxelerate ModelPackage.createPackageContents();

		// Initialize created meta-data
		thePaxelerate ModelPackage.initializePackageContents();

		// Register package validator
		EValidator.Registry.INSTANCE.put
			(thePaxelerate ModelPackage, 
			 new EValidator.Descriptor() {
				 public EValidator getEValidator() {
					 return Paxelerate ModelValidator.INSTANCE;
				 }
			 });

		// Mark meta-data to indicate it can't be changed
		thePaxelerate ModelPackage.freeze();

  
		// Update the registry and return the package
		EPackage.Registry.INSTANCE.put(Paxelerate ModelPackage.eNS_URI, thePaxelerate ModelPackage);
		return thePaxelerate ModelPackage;
	}
	 ...
	 * @generated
	 */
	public Paxelerate ModelFactory getPaxelerate ModelFactory() {
		return (Paxelerate ModelFactory)getEFactoryInstance();
	}
