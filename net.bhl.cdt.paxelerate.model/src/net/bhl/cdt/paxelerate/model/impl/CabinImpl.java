 ...
 * <ul>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.CabinImpl#getCabinLength
 * <em>Cabin Length</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.CabinImpl#getCabinWidth
...
public class CabinImpl extends NamedElementImpl implements Cabin {
	...
	public void setCabinWidth(int newCabinWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CABIN__CABIN_WIDTH, oldCabinWidth,
					cabinWidth));
	}
