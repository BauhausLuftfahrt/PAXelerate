 ...
 * <ul>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#getYPosition
 * <em>YPosition</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#isOnBothSides
 * <em>On Both Sides</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#getWidth <em>Width</em>
 * }</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#getId <em>Id</em>}</li>
 * <li>
 * {@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#getNumberOfSimultaneousPassengers
 * <em>Number Of Simultaneous Passengers</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#isIsActive
 * <em>Is Active</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.DoorImpl#getWaitingPassengers
 * <em>Waiting Passengers</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DoorImpl extends MinimalEObjectImpl.Container implements Door {
	/**
	 * The default value of the '{@link #getYPosition() <em>YPosition</em>}'
	...
	/**
	 * The cached value of the '{@link #getYPosition() <em>YPosition</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getYPosition()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isOnBothSides() <em>On Both Sides</em>}
	 * ' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOnBothSides()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isOnBothSides() <em>On Both Sides</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOnBothSides()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getNumberOfSimultaneousPassengers()
	 * <em>Number Of Simultaneous Passengers</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getNumberOfSimultaneousPassengers()
	 * <em>Number Of Simultaneous Passengers</em>}' attribute. <!--
	 * begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getNumberOfSimultaneousPassengers()
	...
	/**
	 * The default value of the '{@link #isIsActive() <em>Is Active</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsActive()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isIsActive() <em>Is Active</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isIsActive()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getWaitingPassengers()
	 * <em>Waiting Passengers</em>}' reference list. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	public void setYPosition(int newYPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.DOOR__YPOSITION, oldYPosition, yPosition));
	}
	...
	public void setOnBothSides(boolean newOnBothSides) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.DOOR__ON_BOTH_SIDES, oldOnBothSides,
					onBothSides));
	}
	...
	public void setWidth(int newWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.DOOR__WIDTH, oldWidth, width));
	}
	...
	public void setId(int newId) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.DOOR__ID, oldId, id));
	}
	...
	public void setNumberOfSimultaneousPassengers(
			int newNumberOfSimultaneousPassengers) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.DOOR__NUMBER_OF_SIMULTANEOUS_PASSENGERS,
					oldNumberOfSimultaneousPassengers,
					numberOfSimultaneousPassengers));
	}
	...
	public void setIsActive(boolean newIsActive) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.DOOR__IS_ACTIVE, oldIsActive, isActive));
	}
	...
	public EList<Passenger> getWaitingPassengers() {
		if (waitingPassengers == null) {
			waitingPassengers = new EObjectResolvingEList<Passenger>(
					Passenger.class, this,
					CabinPackage.DOOR__WAITING_PASSENGERS);
		}
	...
	public void eSet(int featureID, Object newValue) {
		...
		case CabinPackage.DOOR__WAITING_PASSENGERS:
			...
			getWaitingPassengers()
					.addAll((Collection<? extends Passenger>) newValue);
			return;
		}
	...
	public void eUnset(int featureID) {
		...
		case CabinPackage.DOOR__ID:
			...
			return;
		case CabinPackage.DOOR__NUMBER_OF_SIMULTANEOUS_PASSENGERS:
			setNumberOfSimultaneousPassengers(
					NUMBER_OF_SIMULTANEOUS_PASSENGERS_EDEFAULT);
			return;
		case CabinPackage.DOOR__IS_ACTIVE:
