...
public class CabinPackageImpl extends EPackageImpl implements CabinPackage {
	 ...
	 * 
	 * <p>
	 * This method is used to initialize {@link CabinPackage#eINSTANCE} when
	...
	public static CabinPackage init() {
		if (isInited)
			return (CabinPackage) EPackage.Registry.INSTANCE
					.getEPackage(CabinPackage.eNS_URI);

		// Obtain or create and register package
		CabinPackageImpl theCabinPackage = (CabinPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof CabinPackageImpl
						? EPackage.Registry.INSTANCE.get(eNS_URI)
						: new CabinPackageImpl());
		...
		EValidator.Registry.INSTANCE.put(theCabinPackage,
	...
	public EAttribute getSimulationProperties_SimulateWithoutUI() {
		return (EAttribute) simulationPropertiesEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EReference getSimulationProperties_Results() {
		return (EReference) simulationPropertiesEClass.getEStructuralFeatures()
				.get(25);
	}
	...
	public EAttribute getSimulationResult_BoardingTime() {
		return (EAttribute) simulationResultEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public EAttribute getPhysicalObject_XPosition() {
		return (EAttribute) physicalObjectEClass.getEStructuralFeatures()
				.get(0);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(travelClassEClass,
		...
		createEAttribute(passengerEClass,
				PASSENGER__START_BOARDING_AFTER_DELAY);
		...
		createEAttribute(passengerEClass,
				PASSENGER__NUMBER_OF_MAKE_WAY_OPERATIONS);
		...
		createEOperation(physicalObjectEClass,
				PHYSICAL_OBJECT___OUT_OF_BOUNDS__DIAGNOSTICCHAIN_MAP);
		...
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__SIMULATE_WITHOUT_UI);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__NUMBER_OF_SIMULATION_LOOPS);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__RANDOM_SORT_BETWEEN_LOOPS);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__USE_FOLDABLE_SEATS);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__BRING_YOUR_OWN_SEAT);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGERS_BOARDING_PER_MINUTE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WIDTH_MEAN_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WIDTH_DEVIATION_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WEIGHT_MEAN_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WEIGHT_DEVIATION_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_HEIGHT_MEAN_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_HEIGHT_DEVIATION_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_DEPTH_MEAN_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_DEPTH_DEVIATION_MALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PERCENTAGE_OF_WOMEN);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_LUGGAGE_STOW_TIME_MEAN);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_LUGGAGE_STOW_TIME_DEVIATION);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WIDTH_MEAN_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WIDTH_DEVIATION_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WEIGHT_MEAN_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_WEIGHT_DEVIATION_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_HEIGHT_MEAN_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_HEIGHT_DEVIATION_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_DEPTH_MEAN_FEMALE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PASSENGER_DEPTH_DEVIATION_FEMALE);
		createEReference(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__RESULTS);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PERCENTAGE_OF_PASSENGERS_WITH_NO_LUGGAGE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PERCENTAGE_OF_PASSENGERS_WITH_SMALL_LUGGAGE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PERCENTAGE_OF_PASSENGERS_WITH_MEDIUM_LUGGAGE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__PERCENTAGE_OF_PASSENGERS_WITH_BIG_LUGGAGE);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__SORTING);
		createEAttribute(simulationPropertiesEClass,
				SIMULATION_PROPERTIES__SIMULATION_SPEED_FACTOR);

		simulationResultEClass = createEClass(SIMULATION_RESULT);
		createEAttribute(simulationResultEClass,
				SIMULATION_RESULT__BOARDING_TIME);
		...
		createEAttribute(simulationResultEClass,
				SIMULATION_RESULT__BOARDING_TIME_STRING);
	...
	public void initializePackageContents() {
		...
		initEClass(cabinEClass, Cabin.class, "Cabin", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCabin_CabinLength(), ecorePackage.getEInt(),
				"cabinLength", "2412", 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_CabinWidth(), ecorePackage.getEInt(),
				"cabinWidth", "364", 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_RowNonexistent(), ecorePackage.getEInt(),
				"rowNonexistent", null, 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_AisleWidth(), ecorePackage.getEInt(),
				"aisleWidth", "64", 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_FramesPerSecond(), ecorePackage.getEInt(),
				"framesPerSecond", "5", 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_NumberOfDecks(), ecorePackage.getEInt(),
				"numberOfDecks", "1", 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_SimulationSettings(),
				this.getSimulationProperties(), null, "simulationSettings",
				null, 1, 1, Cabin.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Classes(), this.getTravelClass(), null,
				"classes", null, 1, -1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Doors(), this.getDoor(), null, "doors", null, 1,
				-1, Cabin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Lavatories(), this.getLavatory(), null,
				"lavatories", null, 1, -1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Galleys(), this.getGalley(), null, "galleys",
				null, 1, -1, Cabin.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Stairways(), this.getStairway(), null,
				"stairways", null, 0, -1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Curtains(), this.getCurtain(), null, "curtains",
				null, 0, -1, Cabin.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Stowages(), this.getStowage(), null, "stowages",
				null, 0, -1, Cabin.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getCabin_Passengers(), this.getPassenger(), null,
				"passengers", null, 0, -1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_Scale(), ecorePackage.getEInt(), "scale", "10",
				0, 1, Cabin.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_AircraftType(), this.getAircraftType(),
				"aircraftType", null, 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_UsePresetSettings(), ecorePackage.getEBoolean(),
				"usePresetSettings", "false", 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCabin_SpeedFactor(), ecorePackage.getEInt(),
				"speedFactor", null, 0, 1, Cabin.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(rowEClass, Row.class, "Row", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getRow_Seats(), this.getSeat(), null, "seats", null, 1,
				-1, Row.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getRow_RowNumber(), ecorePackage.getEInt(), "rowNumber",
				null, 0, 1, Row.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getRow_OffsetInRow(), ecorePackage.getEBoolean(),
				"offsetInRow", null, 0, 1, Row.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(travelClassEClass, TravelClass.class, "TravelClass",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTravelClass_Rows(), this.getRow(), null, "rows", null,
				2, -1, TravelClass.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_Sequence(), ecorePackage.getEInt(),
				"sequence", null, 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_Passengers(), ecorePackage.getEInt(),
				"passengers", "0", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_AvailableSeats(), ecorePackage.getEInt(),
				"availableSeats", "0", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_SeatPitch(), ecorePackage.getEInt(),
				"seatPitch", "0", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_SeatLength(), ecorePackage.getEInt(),
				"seatLength", "0", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_SeatWidth(), ecorePackage.getEInt(),
				"seatWidth", "0", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_Name(), ecorePackage.getEString(), "name",
				"Placeholder String", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getTravelClass_RowStructure(), ecorePackage.getEString(),
				"rowStructure", "3-3", 0, 1, TravelClass.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(
				getTravelClass__TooManyPassengers__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "tooManyPassengers", 0, 1,
		...
		op = initEOperation(
				...
				ecorePackage.getEBoolean(), "wrongRowStructure", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "chain", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		...
		initEClass(businessClassEClass, BusinessClass.class, "BusinessClass",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(firstClassEClass, FirstClass.class, "FirstClass",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(economyClassEClass, EconomyClass.class, "EconomyClass",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(premiumEconomyClassEClass, PremiumEconomyClass.class,
				"PremiumEconomyClass", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);

		initEClass(seatEClass, Seat.class, "Seat", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSeat_SeatBlocked(), ecorePackage.getEBoolean(),
				"seatBlocked", null, 0, 1, Seat.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSeat_CrewSeat(), ecorePackage.getEBoolean(),
				"crewSeat", null, 0, 1, Seat.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSeat_Letter(), ecorePackage.getEString(), "letter",
				null, 0, 1, Seat.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getSeat_TravelClass(), this.getTravelClass(), null,
				"travelClass", null, 1, 1, Seat.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getSeat_Row(), this.getRow(), null, "row", null, 1, 1,
				Seat.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSeat_Occupied(), ecorePackage.getEBoolean(),
				"occupied", null, 0, 1, Seat.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getSeat_Passenger(), this.getPassenger(), null,
				"passenger", null, 0, 1, Seat.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getSeat_CurrentlyFolded(), ecorePackage.getEBoolean(),
				"currentlyFolded", "false", 0, 1, Seat.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(passengerEClass, Passenger.class, "Passenger", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPassenger_Id(), ecorePackage.getEInt(), "id", null, 0,
				1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_Sex(), this.getSex(), "sex", null, 0, 1,
				Passenger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_Height(), ecorePackage.getEInt(), "height",
				null, 0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPassenger_Age(), ecorePackage.getEInt(), "age", null,
				0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPassenger_Weight(), ecorePackage.getEInt(), "weight",
				null, 0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getPassenger_Door(), this.getDoor(), null, "door", null,
				1, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_Seat(), ecorePackage.getEInt(), "seat",
				null, 0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPassenger_Name(), ecorePackage.getEString(), "Name",
				"Mr. Placeholder", 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_BoardingTime(), ecorePackage.getEInt(),
				"boardingTime", null, 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getPassenger_SeatRef(), this.getSeat(), null, "seatRef",
				null, 1, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_Width(), ecorePackage.getEInt(), "width",
				null, 0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPassenger_Depth(), ecorePackage.getEInt(), "depth",
				null, 0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getPassenger_OrientationInDegree(),
				ecorePackage.getEDouble(), "orientationInDegree", null, 0, 1,
				Passenger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_PositionX(), ecorePackage.getEDouble(),
				"positionX", null, 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_PositionY(), ecorePackage.getEDouble(),
				"positionY", null, 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_IsSeated(), ecorePackage.getEBoolean(),
				"isSeated", "false", 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_WalkingSpeed(), ecorePackage.getEDouble(),
				"walkingSpeed", "2.0", 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_StartBoardingAfterDelay(),
				ecorePackage.getEDouble(), "startBoardingAfterDelay", "1.0", 0,
				1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_NumberOfWaits(), ecorePackage.getEInt(),
				"numberOfWaits", "0", 0, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_LuggageStowTime(),
				ecorePackage.getEDouble(), "luggageStowTime", "1.0", 0, 1,
				Passenger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEReference(getPassenger_TravelClass(), this.getTravelClass(), null,
				"travelClass", null, 1, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_PassengerMood(), this.getPassengerMood(),
				"passengerMood", null, 1, 1, Passenger.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_NumberOfMakeWayOperations(),
				ecorePackage.getEInt(), "numberOfMakeWayOperations", "0", 0, 1,
				Passenger.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getPassenger_Luggage(), this.getLuggageSize(), "luggage",
				null, 0, 1, Passenger.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(crewMemberEClass, CrewMember.class, "CrewMember",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCrewMember_Id(), ecorePackage.getEInt(), "id", null,
				0, 1, CrewMember.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getCrewMember_Seat(), this.getSeat(), null, "seat", null,
				0, 1, CrewMember.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(physicalObjectEClass, PhysicalObject.class, "PhysicalObject",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getPhysicalObject_XPosition(), ecorePackage.getEInt(),
				"xPosition", null, 0, 1, PhysicalObject.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPhysicalObject_YPosition(), ecorePackage.getEInt(),
				"yPosition", null, 0, 1, PhysicalObject.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPhysicalObject_XDimension(), ecorePackage.getEInt(),
				"xDimension", null, 0, 1, PhysicalObject.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPhysicalObject_YDimension(), ecorePackage.getEInt(),
				"yDimension", null, 0, 1, PhysicalObject.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPhysicalObject_Name(), ecorePackage.getEString(),
				"name", null, 0, 1, PhysicalObject.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getPhysicalObject_Id(), ecorePackage.getEInt(), "id",
				"0", 0, 1, PhysicalObject.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		op = initEOperation(
				getPhysicalObject__OutOfBounds__DiagnosticChain_Map(),
				ecorePackage.getEBoolean(), "outOfBounds", 0, 1, IS_UNIQUE,
				IS_ORDERED);
		addEParameter(op, ecorePackage.getEDiagnosticChain(), "chain", 0, 1,
				IS_UNIQUE, IS_ORDERED);
		g1 = createEGenericType(ecorePackage.getEMap());
		...
		initEClass(lavatoryEClass, Lavatory.class, "Lavatory", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(galleyEClass, Galley.class, "Galley", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(stairwayEClass, Stairway.class, "Stairway", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getStairway_Direction(), this.getStairwayDirection(),
				"direction", null, 0, 1, Stairway.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(curtainEClass, Curtain.class, "Curtain", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getCurtain_PostitionAfterRow(), ecorePackage.getEInt(),
				"postitionAfterRow", null, 0, 1, Curtain.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getCurtain_CurtainOpen(), ecorePackage.getEBoolean(),
				"curtainOpen", null, 0, 1, Curtain.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);

		initEClass(stowageEClass, Stowage.class, "Stowage", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(doorEClass, Door.class, "Door", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getDoor_YPosition(), ecorePackage.getEInt(), "yPosition",
				null, 0, 1, Door.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getDoor_OnBothSides(), ecorePackage.getEBoolean(),
				"onBothSides", null, 0, 1, Door.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getDoor_Width(), ecorePackage.getEInt(), "width", null,
				0, 1, Door.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDoor_Id(), ecorePackage.getEInt(), "id", null, 0, 1,
				Door.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDoor_NumberOfSimultaneousPassengers(),
				ecorePackage.getEInt(), "numberOfSimultaneousPassengers", null,
				0, 1, Door.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE,
				!IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(getDoor_IsActive(), ecorePackage.getEBoolean(),
				"isActive", "true", 0, 1, Door.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEReference(getDoor_WaitingPassengers(), this.getPassenger(), null,
				"waitingPassengers", null, 0, -1, Door.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(mainDoorEClass, MainDoor.class, "MainDoor", !IS_ABSTRACT,
				!IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(emergencyExitEClass, EmergencyExit.class, "EmergencyExit",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(standardDoorEClass, StandardDoor.class, "StandardDoor",
				!IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

		initEClass(simulationPropertiesEClass, SimulationProperties.class,
				"SimulationProperties", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSimulationProperties_SimulateWithoutUI(),
				ecorePackage.getEBoolean(), "simulateWithoutUI", "false", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_NumberOfSimulationLoops(),
				ecorePackage.getEInt(), "numberOfSimulationLoops", "1", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_RandomSortBetweenLoops(),
				ecorePackage.getEBoolean(), "randomSortBetweenLoops", "true", 0,
				1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_UseFoldableSeats(),
				ecorePackage.getEBoolean(), "useFoldableSeats", "false", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_BringYourOwnSeat(),
				ecorePackage.getEBoolean(), "bringYourOwnSeat", "false", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengersBoardingPerMinute(),
				ecorePackage.getEDouble(), "passengersBoardingPerMinute", "18",
				1, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWidthMeanMale(),
				ecorePackage.getEDouble(), "passengerWidthMeanMale", "47", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWidthDeviationMale(),
				ecorePackage.getEDouble(), "passengerWidthDeviationMale", "2.8",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWeightMeanMale(),
				ecorePackage.getEDouble(), "passengerWeightMeanMale", "90", 0,
				1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWeightDeviationMale(),
				ecorePackage.getEDouble(), "passengerWeightDeviationMale", "20",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerHeightMeanMale(),
				ecorePackage.getEDouble(), "passengerHeightMeanMale", "177.5",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerHeightDeviationMale(),
				ecorePackage.getEDouble(), "passengerHeightDeviationMale",
				"11.1", 0, 1, SimulationProperties.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerDepthMeanMale(),
				ecorePackage.getEDouble(), "passengerDepthMeanMale", "30", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerDepthDeviationMale(),
				ecorePackage.getEDouble(), "passengerDepthDeviationMale", "5",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PercentageOfWomen(),
				ecorePackage.getEDouble(), "percentageOfWomen", "50", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerLuggageStowTimeMean(),
				ecorePackage.getEDouble(), "passengerLuggageStowTimeMean", "15",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(
				getSimulationProperties_PassengerLuggageStowTimeDeviation(),
				ecorePackage.getEDouble(), "passengerLuggageStowTimeDeviation",
				"7", 0, 1, SimulationProperties.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWidthMeanFemale(),
				ecorePackage.getEDouble(), "passengerWidthMeanFemale", "41.4",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWidthDeviationFemale(),
				ecorePackage.getEDouble(), "passengerWidthDeviationFemale",
				"2.8", 0, 1, SimulationProperties.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWeightMeanFemale(),
				ecorePackage.getEDouble(), "passengerWeightMeanFemale", "60", 0,
				1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerWeightDeviationFemale(),
				ecorePackage.getEDouble(), "passengerWeightDeviationFemale",
				"15", 0, 1, SimulationProperties.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerHeightMeanFemale(),
				ecorePackage.getEDouble(), "passengerHeightMeanFemale", "164.5",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerHeightDeviationFemale(),
				ecorePackage.getEDouble(), "passengerHeightDeviationFemale",
				"11.5", 0, 1, SimulationProperties.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerDepthMeanFemale(),
				ecorePackage.getEInt(), "passengerDepthMeanFemale", "27", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_PassengerDepthDeviationFemale(),
				ecorePackage.getEDouble(), "passengerDepthDeviationFemale", "3",
				0, 1, SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEReference(getSimulationProperties_Results(),
				this.getSimulationResult(), null, "results", null, 0, -1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES,
				!IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		initEAttribute(
				...
				"percentageOfPassengersWithNoLuggage", null, 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(
				...
				ecorePackage.getEDouble(),
				"percentageOfPassengersWithSmallLuggage", null, 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(
				...
				ecorePackage.getEDouble(),
				"percentageOfPassengersWithMediumLuggage", null, 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(
				...
				ecorePackage.getEDouble(),
				"percentageOfPassengersWithBigLuggage", null, 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_Sorting(),
				this.getSortingStyle(), "sorting", null, 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationProperties_SimulationSpeedFactor(),
				ecorePackage.getEInt(), "simulationSpeedFactor", "10", 0, 1,
				SimulationProperties.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);

		initEClass(simulationResultEClass, SimulationResult.class,
				"SimulationResult", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getSimulationResult_BoardingTime(),
				ecorePackage.getEDouble(), "boardingTime", null, 0, 1,
				SimulationResult.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationResult_Passengers(), ecorePackage.getEInt(),
				"passengers", null, 0, 1, SimulationResult.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationResult_Name(), ecorePackage.getEString(),
				"name", null, 0, 1, SimulationResult.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationResult_Id(), ecorePackage.getEInt(), "id",
				null, 0, 1, SimulationResult.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		initEAttribute(getSimulationResult_Date(), ecorePackage.getEDate(),
				"date", null, 1, 1, SimulationResult.class, !IS_TRANSIENT,
				!IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE,
				!IS_DERIVED, IS_ORDERED);
		initEAttribute(getSimulationResult_BoardingTimeString(),
				ecorePackage.getEString(), "boardingTimeString", null, 0, 1,
				SimulationResult.class, !IS_TRANSIENT, !IS_VOLATILE,
				IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED,
				IS_ORDERED);
		...
		initEEnum(stairwayDirectionEEnum, StairwayDirection.class,
				"StairwayDirection");
