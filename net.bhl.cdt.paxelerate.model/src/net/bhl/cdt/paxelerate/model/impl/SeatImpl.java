 ...
 * <ul>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#isSeatBlocked
 * <em>Seat Blocked</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#isCrewSeat
 * <em>Crew Seat</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#getLetter
 * <em>Letter</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#getTravelClass
 * <em>Travel Class</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#getRow <em>Row</em>}
 * </li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#isOccupied
 * <em>Occupied</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#getPassenger
 * <em>Passenger</em>}</li>
 * <li>{@link net.bhl.cdt.paxelerate.model.impl.SeatImpl#isCurrentlyFolded
...
public class SeatImpl extends PhysicalObjectImpl implements Seat {
	/**
	 * The default value of the '{@link #isSeatBlocked() <em>Seat Blocked</em>}'
	...
	/**
	 * The cached value of the '{@link #isSeatBlocked() <em>Seat Blocked</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSeatBlocked()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isCrewSeat() <em>Crew Seat</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isCrewSeat()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isCrewSeat() <em>Crew Seat</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isCrewSeat()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getLetter() <em>Letter</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getLetter()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isOccupied() <em>Occupied</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOccupied()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isOccupied() <em>Occupied</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isOccupied()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getPassenger() <em>Passenger</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getPassenger()
	 * @generated
	...
	/**
	 * The default value of the '{@link #isCurrentlyFolded()
	...
	/**
	 * The cached value of the '{@link #isCurrentlyFolded()
	 * <em>Currently Folded</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #isCurrentlyFolded()
	...
	public void setSeatBlocked(boolean newSeatBlocked) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SEAT__SEAT_BLOCKED, oldSeatBlocked,
					seatBlocked));
	}
	...
	public void setCrewSeat(boolean newCrewSeat) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SEAT__CREW_SEAT, oldCrewSeat, crewSeat));
	}
	...
	public void setLetter(String newLetter) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SEAT__LETTER, oldLetter, letter));
	}
			...
			if (travelClass != oldTravelClass) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CabinPackage.SEAT__TRAVEL_CLASS, oldTravelClass,
							travelClass));
			}
		}
		return travelClass;
	...
	public Row getRow() {
		if (row != null && row.eIsProxy()) {
			...
			if (row != oldRow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CabinPackage.SEAT__ROW, oldRow, row));
			}
		}
		return row;
	}
	...
	public void setOccupied(boolean newOccupied) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SEAT__OCCUPIED, oldOccupied, occupied));
	}
	...
	public Passenger getPassenger() {
		if (passenger != null && passenger.eIsProxy()) {
			...
			if (passenger != oldPassenger) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
							CabinPackage.SEAT__PASSENGER, oldPassenger,
							passenger));
			}
		}
		return passenger;
	...
	public void setPassenger(Passenger newPassenger) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SEAT__PASSENGER, oldPassenger, passenger));
	}
	...
	public void setCurrentlyFolded(boolean newCurrentlyFolded) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.SEAT__CURRENTLY_FOLDED, oldCurrentlyFolded,
					currentlyFolded));
	}
	...
	public boolean eIsSet(int featureID) {
		...
		case CabinPackage.SEAT__LETTER:
			return LETTER_EDEFAULT == null ? letter != null
					: !LETTER_EDEFAULT.equals(letter);
		case CabinPackage.SEAT__TRAVEL_CLASS:
