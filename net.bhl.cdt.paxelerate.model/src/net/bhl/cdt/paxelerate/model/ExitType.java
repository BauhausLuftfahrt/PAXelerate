 ...
 * <em><b>Exit Type</b></em>', and utility methods for working with them. <!--
 * end-user-doc -->
 * 
...
public enum ExitType implements Enumerator {
	/**
	 * The '<em><b>Before Row</b></em>' literal object. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>In Row</b></em>' literal object. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #IN_ROW_VALUE
	 * @generated
	...
	/**
	 * The '<em><b>Between Classes</b></em>' literal object. <!-- begin-user-doc
	 * --> <!-- end-user-doc -->
	 * 
	...
	/**
	 * The '<em><b>Before Row</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of '<em><b>Before Row</b></em>' literal object isn't
	...
	/**
	 * The '<em><b>In Row</b></em>' literal value. <!-- begin-user-doc -->
	 * <p>
	...
	/**
	 * The '<em><b>Between Classes</b></em>' literal value. <!-- begin-user-doc
	 * -->
	 * <p>
	 * If the meaning of '<em><b>Between Classes</b></em>' literal object isn't
	 * clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 * 
	 ...
	 * @generated
	 */
	private static final ExitType[] VALUES_ARRAY = new ExitType[] { BEFORE_ROW,
			IN_ROW, BETWEEN_CLASSES, };

	/**
	 * A public read-only list of all the '<em><b>Exit Type</b></em>'
	 * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<ExitType> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Exit Type</b></em>' literal with the specified
	...
	public static ExitType get(int value) {
		switch (value) {
		case BEFORE_ROW_VALUE:
			return BEFORE_ROW;
		case IN_ROW_VALUE:
			return IN_ROW;
		case BETWEEN_CLASSES_VALUE:
