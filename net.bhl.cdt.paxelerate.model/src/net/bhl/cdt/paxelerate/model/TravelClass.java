 ...
 *   <li>{@link net.bhl.cdt.paxelerate.model.TravelClass#getClassType <em>Class Type</em>}</li>
 * </ul>
 *
...
public interface TravelClass extends EObject {
	 ...
	 * @see #setClassType(TravelOption)
	 * @see net.bhl.cdt.paxelerate.model.CabinPackage#getTravelClass_ClassType()
	 * @model default="EconomyClass" required="true"
	 * @generated
	 */
	TravelOption getClassType();

	/**
	 * Sets the value of the '{@link net.bhl.cdt.paxelerate.model.TravelClass#getClassType <em>Class Type</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 ...
	 * @generated
	 */
	void setClassType(TravelOption value);
