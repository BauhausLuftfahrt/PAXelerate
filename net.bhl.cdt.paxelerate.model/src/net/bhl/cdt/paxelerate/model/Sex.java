 ...
 * <em><b>Sex</b></em>', and utility methods for working with them. <!--
 * end-user-doc -->
 * 
 * @see net.bhl.cdt.paxelerate.model.CabinPackage#getSex()
 * @model
 * @generated
 */
public enum Sex implements Enumerator {
	 ...
	 * @generated
	 */
	public static final List<Sex> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Sex</b></em>' literal with the specified literal
	...
	/**
	 * Returns the '<em><b>Sex</b></em>' literal with the specified integer
	 * value. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
