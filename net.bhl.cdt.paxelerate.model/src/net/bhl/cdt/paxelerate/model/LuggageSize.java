 ...
 * <em><b>Luggage Size</b></em>', and utility methods for working with them.
 * <!-- end-user-doc -->
 * 
...
public enum LuggageSize implements Enumerator {
	 ...
	 * @generated
	 */
	private static final LuggageSize[] VALUES_ARRAY = new LuggageSize[] { SMALL,
			MEDIUM, BIG, NONE, };

	/**
	 * A public read-only list of all the '<em><b>Luggage Size</b></em>'
	 * enumerators. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @generated
	 */
	public static final List<LuggageSize> VALUES = Collections
			.unmodifiableList(Arrays.asList(VALUES_ARRAY));

	/**
	 * Returns the '<em><b>Luggage Size</b></em>' literal with the specified
