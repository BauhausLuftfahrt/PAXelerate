 ...
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getHeight <em>Height
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getAge <em>Age</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getWeight <em>Weight
 * </em>}</li>
 ...
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getBoardingTime <em>
 * Boarding Time</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getSeatRef <em>Seat Ref
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getWidth <em>Width
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getDepth <em>Depth
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getOrientationInDegree
 * <em>Orientation In Degree</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getPositionX <em>
 * Position X</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getPositionY <em>
 * Position Y</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#isIsSeated <em>Is
 * Seated</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getWalkingSpeed <em>
 * Walking Speed</em>}</li>
 * <li>
 * {@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getStartBoardingAfterDelay
 * <em>Start Boarding After Delay</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getNumberOfWaits <em>
 * Number Of Waits</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#isHasLuggage <em>Has
 * Luggage</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getLuggageStowTime <em>
 * Luggage Stow Time</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getTravelClass <em>
 * Travel Class</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.PassengerImpl#getPassengerMood <em>
 * Passenger Mood</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class PassengerImpl extends MinimalEObjectImpl.Container implements
	...
	/**
	 * The cached value of the '{@link #getBoardingTime()
	 * <em>Boarding Time</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getBoardingTime()
	...
	/**
	 * The cached value of the '{@link #getWalkingSpeed()
	 * <em>Walking Speed</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getWalkingSpeed()
	...
	/**
	 * The default value of the '{@link #isHasLuggage() <em>Has Luggage</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isHasLuggage()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #isHasLuggage() <em>Has Luggage</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isHasLuggage()
	 * @generated
	 ...
	 * @generated
	 */
	public synchronized void setOrientationInDegree(
	 ...
	 * @generated
	 */
	public synchronized void setPositionX(double newPositionX) {
		double oldPositionX = positionX;
		positionX = newPositionX;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.PASSENGER__POSITION_X, oldPositionX, positionX));
	}
	 ...
	 * @generated
	 */
	public synchronized void setPositionY(double newPositionY) {
		double oldPositionY = positionY;
		positionY = newPositionY;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.PASSENGER__POSITION_Y, oldPositionY, positionY));
	}
	...
	public void setHasLuggage(boolean newHasLuggage) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.PASSENGER__HAS_LUGGAGE, oldHasLuggage,
					hasLuggage));
	}
