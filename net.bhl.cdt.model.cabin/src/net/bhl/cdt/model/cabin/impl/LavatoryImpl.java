 ...
 * <ul>
 *   <li>{@link net.bhl.cdt.model.cabin.impl.LavatoryImpl#getXPosition <em>XPosition</em>}</li>
 *   <li>{@link net.bhl.cdt.model.cabin.impl.LavatoryImpl#getYPosition <em>YPosition</em>}</li>
 *   <li>{@link net.bhl.cdt.model.cabin.impl.LavatoryImpl#getXDimension <em>XDimension</em>}</li>
 *   <li>{@link net.bhl.cdt.model.cabin.impl.LavatoryImpl#getYDimension <em>YDimension</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
 */
public class LavatoryImpl extends MinimalEObjectImpl.Container implements Lavatory {
	/**
	...
	public void setXPosition(double newXPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CabinPackage.LAVATORY__XPOSITION, oldXPosition, xPosition));
	}
	...
	public void setYPosition(double newYPosition) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CabinPackage.LAVATORY__YPOSITION, oldYPosition, yPosition));
	}
	...
	public void setXDimension(double newXDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CabinPackage.LAVATORY__XDIMENSION, oldXDimension, xDimension));
	}
	...
	public void setYDimension(double newYDimension) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CabinPackage.LAVATORY__YDIMENSION, oldYDimension, yDimension));
	}
