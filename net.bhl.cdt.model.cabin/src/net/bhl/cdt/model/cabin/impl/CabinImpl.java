 ...
 * <ul>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getCabinLength <em>Cabin
 * Length</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getCabinWidth <em>Cabin
 * Width</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getRowNonexistent <em>Row
 * Nonexistent</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getAisleWidth <em>Aisle
 * Width</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getFramesPerSecond <em>
 * Frames Per Second</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getNumberOfDecks <em>Number
 * Of Decks</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getClasses <em>Classes
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getDoors <em>Doors</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getLavatories <em>
 * Lavatories</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getGalleys <em>Galleys
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getStairways <em>Stairways
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getCurtains <em>Curtains
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getStowages <em>Stowages
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getPassengers <em>
 * Passengers</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getScale <em>Scale</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getRealElapsedTime <em>Real
 * Elapsed Time</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getAircraftType <em>
 * Aircraft Type</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#isUsePresetSettings <em>Use
 * Preset Settings</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getSpeedFactor <em>Speed
 * Factor</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.CabinImpl#getEstimatedSimulationTime
 * <em>Estimated Simulation Time</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CabinImpl extends NamedElementImpl implements Cabin {
	/**
	 * The default value of the '{@link #getCabinLength() <em>Cabin Length</em>}
	...
	/**
	 * The cached value of the '{@link #getCabinLength() <em>Cabin Length</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getCabinLength()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getCabinWidth() <em>Cabin Width</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getCabinWidth()
	 * @generated
	...
	/**
	 * The cached value of the '{@link #getCabinWidth() <em>Cabin Width</em>}'
	 * attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #getCabinWidth()
	 * @generated
	...
	/**
	 * The default value of the '{@link #getRealElapsedTime()
	 * <em>Real Elapsed Time</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getRealElapsedTime()
	 * <em>Real Elapsed Time</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getRealElapsedTime()
	...
	/**
	 * The cached value of the '{@link #getAircraftType()
	 * <em>Aircraft Type</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getAircraftType()
	...
	/**
	 * The default value of the '{@link #getEstimatedSimulationTime()
	 * <em>Estimated Simulation Time</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	...
	/**
	 * The cached value of the '{@link #getEstimatedSimulationTime()
	 * <em>Estimated Simulation Time</em>}' attribute. <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @see #getEstimatedSimulationTime()
	...
	public void setCabinLength(int newCabinLength) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CABIN__CABIN_LENGTH, oldCabinLength,
					cabinLength));
	}
	...
	public void setCabinWidth(int newCabinWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CABIN__CABIN_WIDTH, oldCabinWidth, cabinWidth));
	}
	...
	public EList<Curtain> getCurtains() {
		if (curtains == null) {
			curtains = new EObjectContainmentEList<Curtain>(Curtain.class,
					this, CabinPackage.CABIN__CURTAINS);
		}
		return curtains;
	}
	...
	public EList<Stowage> getStowages() {
		if (stowages == null) {
			stowages = new EObjectContainmentEList<Stowage>(Stowage.class,
					this, CabinPackage.CABIN__STOWAGES);
		}
		return stowages;
	}
	...
	public void setRealElapsedTime(double newRealElapsedTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CABIN__REAL_ELAPSED_TIME, oldRealElapsedTime,
					realElapsedTime));
	}
	...
	public EList<Passenger> getPassengers() {
		if (passengers == null) {
			passengers = new EObjectContainmentEList<Passenger>(
					Passenger.class, this, CabinPackage.CABIN__PASSENGERS);
		}
		return passengers;
	}
	...
	public void setEstimatedSimulationTime(double newEstimatedSimulationTime) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CABIN__ESTIMATED_SIMULATION_TIME,
					oldEstimatedSimulationTime, estimatedSimulationTime));
	}
	...
	public void setAisleWidth(int newAisleWidth) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.CABIN__AISLE_WIDTH, oldAisleWidth, aisleWidth));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd,
		...
		case CabinPackage.CABIN__GALLEYS:
			return ((InternalEList<?>) getGalleys())
					.basicRemove(otherEnd, msgs);
