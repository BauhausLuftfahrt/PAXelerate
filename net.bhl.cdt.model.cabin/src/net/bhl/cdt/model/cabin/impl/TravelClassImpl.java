 ...
 * <ul>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getRows <em>Rows
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getSequence <em>
 * Sequence</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getPassengers <em>
 * Passengers</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getAvailableSeats
 * <em>Available Seats</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getSeatPitch <em>Seat
 * Pitch</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getSeatLength <em>
 * Seat Length</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getSeatWidth <em>Seat
 * Width</em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getName <em>Name
 * </em>}</li>
 * <li>{@link net.bhl.cdt.model.cabin.impl.TravelClassImpl#getRowStructure <em>
 * Row Structure</em>}</li>
 * </ul>
 * </p>
 *
...
public class TravelClassImpl extends MinimalEObjectImpl.Container implements
	...
	/**
	 * The cached value of the '{@link #getRowStructure()
	 * <em>Row Structure</em>}' attribute. <!-- begin-user-doc --> <!--
	 * end-user-doc -->
	 * 
	 * @see #getRowStructure()
	...
	public void setSequence(int newSequence) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					CabinPackage.TRAVEL_CLASS__SEQUENCE, oldSequence, sequence));
	}
