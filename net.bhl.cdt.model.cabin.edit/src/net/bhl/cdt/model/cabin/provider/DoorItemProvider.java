...
/**
 * This is the item provider adapter for a {@link net.bhl.cdt.model.cabin.Door} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DoorItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Door_yPosition_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Door_yPosition_feature", "_UI_Door_type"),
				 CabinPackage.Literals.DOOR__YPOSITION,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		...
		return getString("_UI_Door_type") + " " + door.getId();
	}
