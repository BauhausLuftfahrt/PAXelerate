...
public class ModelAdapterFactory extends AdapterFactoryImpl {
	...
	protected ModelSwitch<Adapter> modelSwitch = new ModelSwitch<Adapter>() {
		...
		@Override
		public Adapter caseEPoint(EPoint object) {
			return createEPointAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.paxelerate.model.EPoint <em>EPoint</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.paxelerate.model.Deck <em>Deck</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link com.paxelerate.model.Model <em>Model</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
