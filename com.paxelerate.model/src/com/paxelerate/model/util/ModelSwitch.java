...
public class ModelSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
		case ModelPackage.SIMULATION_RESULT: {
		...
		case ModelPackage.EPOINT: {
			EPoint ePoint = (EPoint) theEObject;
			T result = caseEPoint(ePoint);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case ModelPackage.DECK: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EPoint</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EPoint</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEPoint(EPoint object) {
		return null;
	}
